...
return array(
	...
	'always_load' => array(
		...
		'classes' => array(
			// 'breadcrumb',
			// array('breadcrumb' => APPPATH.'classes/config/'),
		),
	...
	'path_upload_image' => DOCROOT.'assets/img/upload/image',
	'breadcrumb' => array(
		'admin' => [
			'admin' => 'Dashboard',
			//user page
			'admin/user' => 'User list',
			'admin/user/add' => 'User insert',
			'admin/user/edit' => 'User edit',
			'admin/user/delete' => 'User delete',
			//book page
			'admin/book' => 'Book list',
			'admin/book/add' => 'Book insert',
			'admin/book/edit' => 'Book edit',
			'admin/book/delete' => 'Book delete',
			//export page
			'admin/export' => 'Export excel-pdf-csv',
			'admin/upload' => 'Upload file',
			'admin/upload/edit' => 'Edit file',
			'admin/upload/delete' => 'Delete file',
		...
		'front' => [
			//home page
			'home' => 'Home page',
			'home/user/add' => 'User insert',
			'home/user/edit' => 'User edit',
			'home/user/delete' => 'User delete',
